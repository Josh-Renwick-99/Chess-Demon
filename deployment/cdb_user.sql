...
CREATE TABLE `user` (
  ...
  `winCount` int DEFAULT NULL,
  `gamesPlayed` int DEFAULT NULL,
  `activeGameId` int DEFAULT NULL,
  PRIMARY KEY (`userId`),
...
INSERT INTO `user` VALUES (1,'testUser','2023-02-08',1,1,3),(3,'new','2023-02-08',1,1,6),(15,'918623761996075008','2023-02-09',1,1,105),(16,'918623761996075008?move=undefined','2023-02-09',1,1,18);
...
-- Dump completed on 2023-05-02 12:12:20
